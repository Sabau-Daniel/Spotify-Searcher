...
const CLIENT_ID = "4eb0d6ccfaee4bbf99900fa7078a1b3e";
const CLIENT_SECRET = "564fbbd357b34fce9b04e83ea7161bb8";
...
function App() {
  ...
  // Search function to find artist and their albums
  async function search() {
    console.log("Search for " + searchInput); // Log the search input
  ...
  console.log(albums); // Log the albums array

  return (
    <div className="App">
      <Container>
        {/* Input group for searching artist */}
      ...
      <Container>
        {/* Displaying albums in a responsive grid */}
        <Row className='mx-2 row row-cols-4'>
          {albums.map((album, i) => {
            console.log(album); // Log each album
            return (
              <Card key={i}>
